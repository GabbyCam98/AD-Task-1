        ...
        <section class="landing-page">
            <div class="description-container">
                <div class="travelez-description">
                    ...
                    <p class="description">TravelEZ is a user-friendly website that provides a comprehensive timetable of bus routes across the Philippines. Whether you're planning a trip from Manila to North Luzon or other key destinations, TravelEZ helps you explore available routes offered by various bus companies!</p>
                </div>
